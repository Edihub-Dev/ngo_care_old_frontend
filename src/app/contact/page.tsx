            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 gap-6">
                <div>
                  ...
                  <input type="text" className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-3 placeholder-white/30 text-white focus:outline-none focus:border-[#00b749] transition-colors" placeholder="Full Name" />
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input type="tel" className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-3 placeholder-white/30 text-white focus:outline-none focus:border-[#00b749] transition-colors" placeholder="+1 (555) 000-0000" />
                </div>
              </div>
              <div>
              ...
              <div className="pt-4 border-t border-white/10 mt-6">
                ...
                <button className="w-full bg-[#00b749] hover:bg-[#00a040] text-white font-bold py-4 rounded-xl transition-colors shadow-sm text-lg">
                  Submit Message
                </button>
              </div>
            </form>
