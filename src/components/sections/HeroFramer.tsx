...
export default function HeroFramer() {
  return (
    <section className="relative min-h-[92vh] bg-black">
      ...
      <div className="relative z-10 fr-container pt-28 pb-20">
        <motion.div
        ...
        >
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/about"
              className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-semibold text-black hover:bg-zinc-100 transition-colors"
            >
              Learn About Us
            </Link>
          </div>
